...
import 'package:express_clone/screens/login/widgets/custom_fields/cursor_painter.dart';
import 'package:express_clone/screens/login/widgets/custom_fields/dialog_confirm.dart';
import 'package:express_clone/screens/login/widgets/custom_fields/gradiented.dart';
import 'package:express_clone/screens/login/widgets/custom_fields/haptic_feedback_type.dart';
...
class PinCodeTextFieldAd extends StatefulWidget {
  ...
  final AnimationTypeOne animationType;
  ...
  /// Theme for the pin cells. Read more [PinThemeOne]
  final PinThemeOne pinTheme;
  ...
  /// The vertical padding from the [PinCodeTextFieldAdAd] to the error text
  /// Default is 16.
  ...
  PinCodeTextFieldAd({
    ...
    this.animationType = AnimationTypeOne.slide,
    ...
    this.dialogConfig,
    this.pinTheme = const PinThemeOne.defaults(),
  ...
  @override
  _PinCodeTextFieldAdState createState() => _PinCodeTextFieldAdState();
}
...
class _PinCodeTextFieldAdState extends State<PinCodeTextFieldAd>
  ...
  PinThemeOne get _pinTheme => widget.pinTheme;

  late Timer _blinkDebounce;
        ...
        Container(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                shape: _pinTheme.shape == PinCodeFieldShapeOne.circle
                    ? BoxShape.circle
                    : BoxShape.rectangle,
                borderRadius: borderRadius,
              ...
              child: Center(
                child: AnimatedSwitcher(
                  ...
                  transitionBuilder: (child, animation) {
                    if (widget.animationType == AnimationTypeOne.scale) {
                      return ScaleTransition(
                        scale: animation,
                        child: child,
                      );
                    } else if (widget.animationType == AnimationTypeOne.fade) {
                      return FadeTransition(
                        opacity: animation,
                        child: child,
                      );
                    } else if (widget.animationType == AnimationTypeOne.none) {
                      return child;
                    } else {
                      return SlideTransition(
